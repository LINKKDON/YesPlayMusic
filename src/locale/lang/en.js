export default {
  ...
  login: {
    ...
    notice: `MyMusic promises not to save any of your account information to the cloud.<br />
      Your password will be MD5 encrypted locally and then transmitted to NetEase Music API.<br />
      MyMusic is not the official website of NetEase Music, please consider carefully before entering account information. You can also go to <a href="https://github.com/LINKKDON/MyMusic">MyMusic's GitHub repository</a> to build and use the self-hosted NetEase Music API.`,
    noticeElectron: `Your password will be MD5 encrypted locally and then transmitted to NetEase Music API.<br />
      MyMusic promises not to save any of your account information to the cloud.<br />`,
  },
  mv: {
  ...
  settings: {
    ...
    enableThirdPartySource: {
      title: 'Third-party Source Fallback',
      desc: 'When a logged-in non-member hits a copyright limit, automatically fall back to a third-party source (gdstudio). When off, only the official source is used.',
    },
  },
  contextMenu: {
    play: 'Play',
