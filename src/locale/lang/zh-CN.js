export default {
  ...
  login: {
    ...
    notice: `MyMusic 承诺不会保存你的任何账号信息到云端。<br />
      你的密码会在本地进行 MD5 加密后再传输到网易云 API。<br />
      MyMusic 并非网易云官方网站，输入账号信息前请慎重考虑。 你也可以前往
      <a href="https://github.com/LINKKDON/MyMusic"
        >MyMusic 的 GitHub 源代码仓库</a
      >
      自行构建并使用自托管的网易云 API。`,
    noticeElectron: `你的密码会在本地进行 MD5 加密后再传输到网易云 API。<br />
      MyMusic 不会传输你的账号数据到任何非网易云音乐官方的服务器。<br />`,
  },
  mv: {
    moreVideo: '更多视频',
  },
  ...
  settings: {
    ...
    enableThirdPartySource: {
      title: '第三方音源回退',
      desc: '登录非会员遇到版权限制时，自动回退至第三方音源（gdstudio）；关闭后将仅使用官方音源。',
    },
  },
  contextMenu: {
    play: '播放',
