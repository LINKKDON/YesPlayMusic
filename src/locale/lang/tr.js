export default {
  ...
  login: {
    ...
    notice: `MyMusic hesabınızın hiçbir bilgisini kaydetmeyeceğine dair söz veriyor<br />
      Şifren MD5 şifreleme ile yerel olarak şifrelenir ve daha sonra NetEase Müzik API'sine gönderilir<br />
      MyMusic, NetEase Music'in resmi websitesi değildir, lütfen hesap bilgilerinizi girmeden önce dikkatlice düşününüz. Aynı zamanda, Kendi NetEase Musix API'nızı host etmek için <a href="https://github.com/LINKKDON/MyMusic">MyMusic'in GitHub Repo'suna</a> gidebilirsiniz.`,
    noticeElectron: `MyMusic hesabınızın hiçbir bilgisini kaydetmeyeceğine dair söz veriyor<br />
      Şifren MD5 şifreleme ile yerel olarak şifrelenir ve daha sonra NetEase Müzik API'sine gönderilir<br />`,
  },
  mv: {
  ...
  settings: {
    ...
    enableThirdPartySource: {
      title: 'Üçüncü Taraf Kaynak Yedeklemesi',
      desc: 'Giriş yapmış üye olmayan bir kullanıcı telif hakkı sınırına takıldığında otomatik olarak üçüncü taraf kaynağa (gdstudio) düşer. Kapalıyken yalnızca resmi kaynak kullanılır.',
    },
  },
  contextMenu: {
    play: 'Oynat',
