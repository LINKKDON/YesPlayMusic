export default {
  ...
  login: {
    ...
    notice: `MyMusic 承諾不會保存您的任何帳戶資訊到雲端。<br />
        您的密碼會在本地進行 MD5 加密後再傳輸到網易雲 API。<br />
        MyMusic 並非網易雲官方網站，輸入帳戶資訊前請慎重考慮。 您也可以前往
        <a href="https://github.com/LINKKDON/MyMusic"
          >MyMusic 的 GitHub 原始碼 Repo</a
        >
        自行編譯並使用自託管的網易雲 API。`,
    noticeElectron: `您的密碼會在本地進行 MD5 加密後再傳輸到網易雲 API。<br />
        MyMusic 不會傳輸你的帳戶資料到任何非網易雲音樂官方的伺服器。<br />`,
  },
  mv: {
    moreVideo: '更多影片',
  },
  ...
  settings: {
    ...
    enableThirdPartySource: {
      title: '第三方音源回退',
      desc: '登入非會員遇到版權限制時，自動回退至第三方音源（gdstudio）；關閉後將僅使用官方音源。',
    },
  },
  contextMenu: {
    play: '播放',
