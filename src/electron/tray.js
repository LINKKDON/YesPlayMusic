...
export function createTray(win, eventEmitter, store) {
  ...
  tray.setToolTip('MyMusic');

  return isLinux
    ? new MyMusicTrayLinuxImpl(tray, win, eventEmitter, store)
    : new MyMusicTrayWindowsImpl(tray, win, eventEmitter, store);
}
